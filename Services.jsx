...
const JOB_FEATURES = [
  ...
  { name: 'Job Board Integration (LinkedIn, Indeed, Glassdoor)', desc: 'Connect the platform seamlessly with LinkedIn, Indeed, and Glassdoor so you can apply directly from the Apex Resume Group dashboard without switching between platforms, losing formatting, or re-entering information. Streamline your application process and apply to more quality roles in less time.' },
];
